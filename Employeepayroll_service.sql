...
Insert into Company values ('Shabana'),('Ameer Basha')
Select * from Company
...
(1,'Shabana',9842905050,'5298 Wild Indigo, Georgia,340002','2012-03-28','F'),
(2,'Shakil',9842905550,'Constitution Ave Fairfield, California(CA), 94533','2017-04-22','F'),
(1,'Shafi',7812905050,'Bernard Shaw, Georgia,132001 ','2015-08-22','M'),
(2,'Akhil',78129050000,'Bernard Shaw, PB Marg Bareilly','2012-08-29','M')
